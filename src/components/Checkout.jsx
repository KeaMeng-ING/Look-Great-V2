...
export default function Checkout() {
  ...
  const { total, tax } = location.state || {};
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500      "
                      defaultValue="United States" // Use defaultValue for initial value
                    >
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500      "
                      defaultValue="San Francisco" // Use defaultValue for initial value
                    >
            ...
            <div className="mt-6 w-full space-y-6 sm:mt-8 lg:mt-0 lg:max-w-xs xl:max-w-md">
              <div className="flow-root">
                <div className="-my-3 divide-y divide-gray-200 ">
                  ...
                  <dl className=" items-center justify-between gap-4 py-3 hidden">
                    <dt className="text-base font-normal text-gray-500 ">
                      Savings
                    </dt>
